...
def deal_card():
    ...
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
    deal_value = cards[random.randint(0, 12)]
    return deal_value


def compare(user_score, computer_score):
    if computer_score == user_score:
        return "Its  draw between you and computer  "
    elif computer_score==0:
        return " vomputer having 0 blackjack you loss"
    elif user_score ==0 :
        return "You have 0 blackjacks you win "
    elif user_score > 21:
        return " You loss your score is greter then 21"
    elif computer_score >21 :
        return "You win the game computer's score is over 21"
...
def calculate_score(cards):
    """takes a list of cards and calculate there score from the cards"""
    ...
    if sum(cards)==21 and len(cards)==2:
        return 0#this 0 will represent that  ace in our game.
...
def play_game():
    ...
    #+= is a shortend for extend function which allows to add a new list element 
    # at the and of another list but this must be a list .
    user_cards = []
    computer_cards = []
    is_game_over =False
    ...
    # that takes a List of cards as input
    ...
    while not is_game_over :
        ...
        print(f"Youe cards : {user_cards} . current score {user_score}")
        print(f"computer's First card : {computer_cards[0]} .")
        #print(f"computer's First card : {computer_cards[0]} . computers current score {computer_score}") #
        ...
        # List. If no, then the game has ended.
            ...
            draw_new_card = input("Enter 'y' if you want to draw anothr card or 'n' to pass : ")
            if draw_new_card =='y' or draw_new_card=='Y':
                user_cards.append(deal_card())
    ...
    # The computer should keep drawing cards as long as 
...
while 'y' ==  input("Do you want to play a game backjack? Type 'y' or 'n'"):
    play_game()
